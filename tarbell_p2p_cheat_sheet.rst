...
----------------------------------------
   ...
   #. ``npm install`` Should be done right away after staring a new project. This let's you use grunt, gulp, browserify and other build tools.
...
--------
   ...
   - ``npm run watch``: Run this in it's own tab and it will automatically run build commands when it detects changes to a file. 
